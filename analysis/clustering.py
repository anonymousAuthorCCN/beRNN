...
class Analysis(object):
    ...
    def plot_similarity_matrix(self, model_dir, mode):
        ...
        save_path = os.path.join('W:\\group_csp\\analyses\\XXX', 'BeRNN_models\\Visuals\\Similiarity\\finalReport', model_dir.split("\\")[-1] + '_' + mode + '.png')
    ...
    def plot_2Dvisualization(self, model_dir, mode, method='tSNE'):
        ...
        plt.savefig(os.path.join('W:\\group_csp\\analyses\\XXX', 'BeRNN_models\\Visuals\\2D_Clustering',model_dir.split("\\")[-1] + '_' + mode + '.png'), \
    ...
    def plot_connectivity_byclusters(self, model_dir, mode):
        ...
        ax1.axis('off')
        ax2.axis('off')
        plt.savefig(os.path.join('W:\\group_csp\\analyses\\XXX', 'BeRNN_models\\Visuals\\connectivityByClusters',model_dir.split("\\")[-1] + '_' + mode + '.png'), \
                    format='png', dpi=300, bbox_inches='tight', pad_inches=0.1)
        plt.show()
    ...
    def plot_connectivity_byclusters_WrecOnly(self, model_dir, mode):
        ...
        ax2.axis('off')
        plt.savefig(
            os.path.join('W:\\group_csp\\analyses\\XXX', 'BeRNN_models\\Visuals\\connectivityByClustersWrecOnly\\finalReport',
